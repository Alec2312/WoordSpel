        ...
        <div class="relative flex h-full w-full">
            ...
            <div class="w-1/2 bg-[#FD4D4B] flex items-center justify-center relative pointer-events-none">
                ...
                <img
                    ...
                    alt="Profielfoto"
                    class="rounded-full border-4 border-white w-24 h-24 object-cover shadow-lg pointer-events-auto"
                />
            </div>
            ...
            <div class="w-1/2 bg-[#00BBFC] flex items-center justify-center relative pointer-events-none">
                ...
                <button>
                    <img
                        ...
                        class="rounded-full border-4 border-white w-24 h-24 object-cover shadow-md cursor-pointer hover:brightness-90 transition"
                    />
                </button>
            </div>
            ...
            <div class="absolute inset-0 flex items-center justify-center z-10">
                <a href="{{ route('play') }}" class="pointer-events-auto">
                    <img
