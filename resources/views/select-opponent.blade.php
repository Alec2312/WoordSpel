...
<div class="max-w-md mx-auto p-8 bg-white rounded-xl shadow-lg text-center">
    ...
    <form method="POST" action="{{ route('game.set-opponent') }}">
        @csrf
        <div class="mb-6">
            <label for="opponent_id" class="block text-gray-700 text-lg font-medium mb-3">Selecteer een Speler
                2:</label>
            <select name="opponent_id" id="opponent_id"
        ...
        <button type="submit"
                class="bg-blue-600 text-white font-bold py-3 px-6 rounded-lg shadow-lg hover:bg-blue-700 transition duration-300 ease-in-out">
